...
public class LocationProvider implements LifecycleObserver {
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(final LocationResult locationResult) {
                ...
                if (Latitude == 0.0 && Longitude == 0.0) {
                    ...
                    callback.onLocationUpdated(Latitude, Longitude,locationProvider);
                }
            }
        };
    }
    ...
    public interface MLocationCallback {
        ...
        void onLocationUpdated(double latitude, double longitude,LocationProvider locationProvider);
